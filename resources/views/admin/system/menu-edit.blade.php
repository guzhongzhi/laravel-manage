<div class="widget-content nopadding">
  <form action="#" method="get" class="form-horizontal">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <div class="select2-container select2-container-multi" id="s2id_autogen2">    <ul class="select2-choices">  <li class="select2-search-choice">    <div>Second option</div>    <a href="#" onclick="return false;" class="select2-search-choice-close" tabindex="-1"></a></li><li class="select2-search-field">    <input type="text" autocomplete="off" class="select2-input" tabindex="0" style="width: 10px;">  </li></ul><div class="select2-drop select2-drop-multi" style="display:none;">   <ul class="select2-results">   </ul></div></div><select multiple="" style="display: none;">
          <option>First option</option>
